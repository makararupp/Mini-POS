...
import makara.co.min_pos.models.entities.Role;
import makara.co.min_pos.models.entities.User;
import makara.co.min_pos.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public Optional<AuthUser> findUserByUsername(String username) {
         ...
         AuthUser authUser = AuthUser.builder()
                ...
                .getAuthorities(getAuthorities(user.getRoles()))
                 .accountNonExpired(user.isAccountNonExpired())
                 .accountNonLocked(user.isAccountNonLocked())
                 .credentialsNonExpired(user.isCredentialsNoExpired())
